...
def run_tests(data_dir="./data/random", checkpoint_dir="./pretrained"):
    ...
    test_configs = [
        # TSPTW size 50
        {
            ...
            "checkpoint": "./pretrained/reld/tsptw50-easy-reld.pth"
        },
        
        {
            ...
            "hardness": "medium",
            "max_backtrack_steps": 100,
            "checkpoint": "./pretrained/reld/tsptw50-medium-reld.pth"
        },
        
        {
            ...
            "checkpoint": "./pretrained/reld/tsptw50-hard-reld.pth"
        ...
        # TSPTW size 100
        {
            ...
            "checkpoint": "./pretrained/reld/tsptw100-easy-reld.pth"
        ...
        },
        {
            ...
            "hardness": "medium",
            "max_backtrack_steps": 200,
            "checkpoint": "./pretrained/reld/tsptw100-medium-reld.pth"
        ...
        },
        {
            ...
            "checkpoint": "./pretrained/reld/tsptw100-hard-reld.pth"
        ...
        # TSPDL size 50
        {
            ...
            "hardness": "medium",
            "max_backtrack_steps": 150,
            "checkpoint": "./pretrained/reld/tspdl50-medium-reld.pth"
        ...
        },
        {
            ...
            "hardness": "hard",
            "max_backtrack_steps": 150,
            "checkpoint": "./pretrained/reld/tspdl50-hard-reld.pth"
        ...
        # TSPDL size 100
        {
            ...
            "hardness": "medium",
            "max_backtrack_steps": 150,
            "checkpoint": "./pretrained/reld/tspdl100-medium-reld.pth"
        ...
        },
        {
            ...
            "hardness": "hard",
            "max_backtrack_steps": 150,
            "checkpoint": "./pretrained/reld/tspdl100-hard-reld.pth"
    ...
    csv_path = f"./results/reld_results.csv"
